...
module.exports = {
    ...
    execute(message, args) {
        ...
        .setTitle("This command is temporarily unavailable.")
        .setColor('#ff0000')
        .setDescription("Give us time to receive additional intents from discord so that we can bring this command back up.")
        .setFooter("<3 - Patross"));
        // //grab a non bot user
